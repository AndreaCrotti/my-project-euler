...
* Problems
 ...
 |  38 | What is the largest 1 to 9 pandigital 9-digit number that can be formed as the concatenated product of an integer with (1,2, ... , n) where n  1? | [[file:temp/prob_38.py][?]]  | [[elisp:(find-file "temp/prob_38.hs")][_]]  | [[elisp:(find-file "temp/prob_38.rb")][_]]  | [[elisp:(find-file "temp/prob_38.c")][_]] | [[elisp:(find-file "temp/prob_38.cpp")][_]]   | [[elisp:(find-file "temp/prob_38.nb")][_]]  |              | N         |
 |  34 | Find the sum of all numbers which are equal to the sum of the factorial of their digits. | [[elisp:(find-file "temp/prob_34.py")][_]]  | [[elisp:(find-file "temp/prob_34.hs")][_]]  | [[elisp:(find-file "temp/prob_34.rb")][_]]  | [[elisp:(find-file "temp/prob_34.c")][_]] | [[elisp:(find-file "temp/prob_34.cpp")][_]]   | [[elisp:(find-file "temp/prob_34.nb")][_]]  |              | N         |
 |-----+----------------------------------------------------+----+----+----+---+-----+----+--------------+-----------|
